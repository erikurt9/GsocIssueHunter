...
export const metadata: Metadata = {
  ...
  description: "Discover open, unassigned GitHub issues from GSoC 2026 organizations and beyond. Filter by 'good first issue', GSoC-official orgs, or any keyword.",
  keywords: "open source, github, first contribution, good first issue, gsoc 2026, beginner friendly, coding, programming",
  openGraph: {
    title: "FirstIssue - Open Source Gateway",
    description: "Find your next open source contribution across all of GitHub — filter by good first issue, org, or keyword",
    type: "website",
  },
};
